package com.sdlifes.videolibrary.player;
...
import com.sdlifes.videolibrary.R;
import com.sdlifes.videolibrary.controller.BaseVideoController;
import com.sdlifes.videolibrary.controller.MediaPlayerControl;
import com.sdlifes.videolibrary.render.IRenderView;
import com.sdlifes.videolibrary.render.RenderViewFactory;
import com.sdlifes.videolibrary.util.L;
import com.sdlifes.videolibrary.util.PlayerUtils;
...
public class VideoView<P extends AbstractPlayer> extends FrameLayout
    ...
    protected boolean prepareDataSource() {
        if (mAssetFileDescriptor != null) {
            ...
            Log.e("TAG_中文","mUrl="+mUrl);
            int lastIndex = mUrl.lastIndexOf("/");
            String lastUrl = mUrl.substring(lastIndex + 1);
            Log.e("TAG_中文","lastUrl="+lastUrl);
            String startUrl = mUrl.substring(0,lastIndex+1);
            Log.e("TAG_中文","startUrl="+startUrl);
            String lastEncode = null;
            try {
                lastEncode = URLEncoder.encode(lastUrl, "UTF-8");
                String URL5 =startUrl+lastEncode;
                Log.e("TAG_中文","URL5="+URL5);
                String url = "http://122.114.222.233:8080/videos/iPhone12%E6%9C%80%E6%96%B0%E6%9C%BA%E6%A8%A1%E6%9B%9D%E5%85%89%EF%BC%9A%E8%87%B4%E6%95%ACiPhone%204%EF%BC%9F.mp4";
