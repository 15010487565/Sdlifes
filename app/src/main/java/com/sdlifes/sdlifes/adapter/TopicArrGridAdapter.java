...
public class TopicArrGridAdapter extends BaseAdapter {
    private LayoutInflater mInflater;
    private List<HomeCatModel.DataBean.TopicArrBean> list;
    private Context context;

    public TopicArrGridAdapter(Context context) {
        this.context = context;
        this.mInflater = LayoutInflater.from(context);
    }

    public List<HomeCatModel.DataBean.TopicArrBean> getData() {
        return list;
    }
    public void setData(List<HomeCatModel.DataBean.TopicArrBean> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        HomeCatModel.DataBean.TopicArrBean topicArrBean = list.get(position);
