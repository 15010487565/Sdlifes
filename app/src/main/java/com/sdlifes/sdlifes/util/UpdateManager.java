...
public class UpdateManager {
    ...
    //读写权限
    private final static int REQUEST_CODE_APP_DOWN = 10010;
    protected static final String[] DOWNPERMISSION = {
    ...
    private void isPermissionRead() {

        PermissionsChecker mChecker = new PermissionsChecker(mActivity);
        if (mChecker.lacksPermissions(DOWNPERMISSION)) {
            // 请求权限
            PermissionsActivity.startActivityForResult(mActivity,REQUEST_CODE_APP_DOWN, DOWNPERMISSION);
        } else {
            // 全部权限都已获取
            showDownloadDialog();
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.e("TAG_安装App","requestCode="+requestCode+";resultCode="+resultCode);
