...
#JavaBean
-keepclassmembers public class com.sdlifes.sdlifes.model.** {
   void set*(***);
   *** get*();
}
-keep class com.sdlifes.sdlifes.fun.** { *; }

-keep class com.sdlifes.sdlifes.JavaScriptInterface { *; }#webview js
